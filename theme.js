...
(function () {
  ...
  /* ---------- site map ---------- */
  var GAMES = [
    { slug: "snake",    label: "Змейка",      em: "🐍", lessons: ["Окно","Квадрат","Змейка-список","Движение","Стрелки","Еда и рост","Игра окончена","Функции"] },
  ...
  var ROBOTS = [
    { slug: "basics", label: "Основы электроники", em: "⚡", lessons: ["Электричество","Светодиод и резистор","Кнопка","Транзистор","Мотор и H-мост","Мостик к Arduino","ESP32 по WiFi"] },
