"""
Змейка с функциями: тот же код, что snake.py, но «куски» вынесены в функции
с именами. Игра ведёт себя точно так же — зато главный цикл стал короче и читается
как рассказ: «нарисуй еду, нарисуй змейку».
Стрелки — управление, пробел — заново. F — полный экран, ESC — выход.
"""
...
def draw_food(screen, food):
    """Рисует яблоко красным квадратом."""
    rect = pygame.Rect(food[0] * CELL, food[1] * CELL, CELL, CELL)
    pygame.draw.rect(screen, RED, rect)


def draw_snake(screen, snake):
    """Рисует голову ярко-зелёным, а хвост — тёмным."""
...
while True:
    ...
    # 3. Рисование — теперь одной строкой на каждый кусок
    screen.fill(BLACK)
